...
const Titlle = ({
  ...
  <div className="pl-44 ">
    <div className="flex flex-col text-firebrick">
      <div className="flex flex-row gap-10 flex-wrap items-start justify-start text-[50px] ">
      ...
      <div className=" flex flex-row gap-12 flex-wrap items-start justify-start  text-[37px]">
        <h1 className="  text-lightpink  font-normal grotesk">
          day
        </h1>      
  ...
  <div className=" flex flex-row  items-center justify-center">
    ...
    <div className="flex flex-col  items-start justify-start px-0 pb-0 pt-12">

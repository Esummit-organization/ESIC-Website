...
export function Footer() {
  const currentYear = new Date().getFullYear();
    ...
    //     <div className="w-full px-5 py-12 bg-secondary-950 text-white">
    ...
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >Home</a>
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >Events</a>
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >Accomadation</a>
    //             </div>
    //             <div className="  text-gray-400 flex flex-col gap-2">
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >About Us</a>
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >Contact</a>
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >Team</a>
    //               <a href="/" className="inline-block leading-loose text-white opacity-70 hover:text-secondary-100" >Blogs</a>
    //             </div>
    //           </div>
    //         </div>
    //         <div>

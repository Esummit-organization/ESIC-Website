...
export function FAQ() {
    ...
    return (
        <div className="bg-secondary-950 p-10 pt-6 md:p-20 lg:p-28">
            <div className="max-w-full mx-auto p-4 pt-6 md:p-6 lg:p-12 bg-background-950 rounded shadow-md">
                <h2 className="text-4xl font-bold mb-4 grotesk text-white">FAQs</h2>
                <p className="poppins text-[11px] md:text-xl my-1 mb-14 text-[#0063c0]">Answers to the most frequently asked questions.</p>

...
import { MarqueScroll } from "../Marque/Marque";
...
export function Hero() {
	...
	return (
		<div>
			<div className="hero-section-div relative w-full h-[100vh] lg:h-[120vh] hide-scrollbar z-[5] overflow-hidden bg-background-150">
				<Plx
					parallaxData={[
						{
							start: 0,

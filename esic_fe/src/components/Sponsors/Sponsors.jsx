    ...
    return (
        ...
        <div className="bg-gradient-to-br to-background-900 from-hero-50 dark:from-background">
            <div className=" px-14 pt-10">
                <h1 style={{ WebkitBackgroundClip: 'text' }} className='text-5xl lg:text-8xl text-white grotesk bg-gradient-to-t from-gray-800 to-white text-transparent bg-clip-text'>Sponsors</h1>
                <div className="flex items-center">
                    <hr className='w-20 border-t-2 border-[#006DD5] ' />
                    <p className="poppins lG:text-xl mx-3 my-1 text-[#006DD5]">View all Sponsors</p>
